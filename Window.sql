...
INSERT INTO item (id, name, price) VALUES (1, 'Laptop', 70000);
INSERT INTO item (id, name, price) VALUES (2, 'Smartphone', 25000);
INSERT INTO item (id, name, price) VALUES (3, 'Headphones', 5000);
INSERT INTO item (id, name, price) VALUES (4, 'Smartwatch', 12000);
INSERT INTO item (id, name, price) VALUES (5, 'Tablet', 30000);

-- Insert data into orders table (6 different orders for each item)
INSERT INTO orders (id, item_id, order_date) VALUES (101, 1, TO_DATE('2024-02-01', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (102, 1, TO_DATE('2024-02-05', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (103, 1, TO_DATE('2024-02-10', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (104, 1, TO_DATE('2024-02-15', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (105, 1, TO_DATE('2024-02-20', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (106, 1, TO_DATE('2024-02-25', 'YYYY-MM-DD'));

INSERT INTO orders (id, item_id, order_date) VALUES (107, 2, TO_DATE('2024-02-02', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (108, 2, TO_DATE('2024-02-06', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (109, 2, TO_DATE('2024-02-11', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (110, 2, TO_DATE('2024-02-16', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (111, 2, TO_DATE('2024-02-21', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (112, 2, TO_DATE('2024-02-26', 'YYYY-MM-DD'));

INSERT INTO orders (id, item_id, order_date) VALUES (113, 3, TO_DATE('2024-02-03', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (114, 3, TO_DATE('2024-02-07', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (115, 3, TO_DATE('2024-02-12', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (116, 3, TO_DATE('2024-02-17', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (117, 3, TO_DATE('2024-02-22', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (118, 3, TO_DATE('2024-02-27', 'YYYY-MM-DD'));

INSERT INTO orders (id, item_id, order_date) VALUES (119, 4, TO_DATE('2024-02-04', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (120, 4, TO_DATE('2024-02-08', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (121, 4, TO_DATE('2024-02-13', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (122, 4, TO_DATE('2024-02-18', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (123, 4, TO_DATE('2024-02-23', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (124, 4, TO_DATE('2024-02-28', 'YYYY-MM-DD'));

INSERT INTO orders (id, item_id, order_date) VALUES (125, 5, TO_DATE('2024-02-01', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (126, 5, TO_DATE('2024-02-09', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (127, 5, TO_DATE('2024-02-14', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (128, 5, TO_DATE('2024-02-19', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (129, 5, TO_DATE('2024-02-24', 'YYYY-MM-DD'));
INSERT INTO orders (id, item_id, order_date) VALUES (130, 5, TO_DATE('2024-02-29', 'YYYY-MM-DD'));

--On which date the sales have crossed 5 lakhs?
SELECT i.id,i.name,i.price,o.order_date,
SUM(i.price) OVER(ORDER BY o.order_date) AS running_total
FROM item i JOIN orders o
ON i.id=o.item_id


--SET OPERATORS IN SQL:
--UNION,UNION ALL,INTERSECT,MINUS are called as set operators in sql
--They are used to perform set operations on two result sets
--These are usually applied between the results of two SELECT statements

--UNION:
--Used to find the total records from two result sets,but doesn't contain duplicates
--SYNTAX: SELECT ....
     --   UNION  ....
    --    SELECT ....
SELECT name FROM employee WHERE department='SW'
INTERSECT
SELECT name FROM 

SELECT id,name,department,date_of_joining
FROM employee
WHERE department='HR' and date_of_joining BETWEEN TO_DATE('01-01-2022','DD-MM-YYYY') AND TO_DATE('31-12-2022','DD-MM-YYYY');


SELECT id,name,department,date_of_joining
FROM employee
WHERE department='HR' AND TO_CHAR(date_of_joining,'YYYY')=2022;
...
FROM item i JOIN orders o
ON i.id=o.item_id;
WHERE o.order_date > TO_DATE('15-02-2024','DD-MM-YYYY');
